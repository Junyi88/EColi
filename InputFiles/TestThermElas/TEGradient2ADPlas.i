...
[Kernels]
  ...
  [./TensorMechanics]
      displacements = 'disp_x disp_y disp_z'
      eigenstrain_names        = EigenStrain
      strain                        = FINITE           # Strain formulation
      temp                          = Te                # The temperature
      temperature                   = Te
  [../]
...
#  show_actions            = 1       # Print out the actions being executed
#  show_material_props     = 1       # Print out the material properties supplied for each block, face, neighbor,
#                                    # and/or sideset
#  show_parser             = 1       # Shows parser block extraction and debugging information
