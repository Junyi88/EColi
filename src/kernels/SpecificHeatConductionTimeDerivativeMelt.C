...
template <>
InputParameters
validParams<SpecificHeatConductionTimeDerivativeMelt>()
{
...
SpecificHeatConductionTimeDerivativeMelt::SpecificHeatConductionTimeDerivativeMelt(
...
Real
SpecificHeatConductionTimeDerivativeMelt::computeQpResidual()
{
...
Real
SpecificHeatConductionTimeDerivativeMelt::computeQpJacobian()
{
...
Real
SpecificHeatConductionTimeDerivativeMelt::computeQpOffDiagJacobian(unsigned int jvar)
{
  if (((_u[_qp]>=_Tmelt)&&(_Eta[_qp]<1.0))||((_u[_qp]<=_Tmelt)&&(_Eta[_qp]>0.0))) {
