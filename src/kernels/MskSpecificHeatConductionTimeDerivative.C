...
template <>
InputParameters
validParams<MskSpecificHeatConductionTimeDerivative>()
{
...
MskSpecificHeatConductionTimeDerivative::MskSpecificHeatConductionTimeDerivative(
...
Real
MskSpecificHeatConductionTimeDerivative::computeQpResidual()
{
  if (_Mask[_qp]<0.5)
    return 0.0;
...
Real
MskSpecificHeatConductionTimeDerivative::computeQpJacobian()
{
  if (_Mask[_qp]<0.5)
    return 0.0;
...
Real
MskSpecificHeatConductionTimeDerivative::computeQpOffDiagJacobian(unsigned int jvar)
{
  if (_Mask[_qp]<0.5)
    return 0.0;
