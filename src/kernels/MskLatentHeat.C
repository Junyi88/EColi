...
//** Constructor *********************************************************
MskLatentHeat::MskLatentHeat(const InputParameters & parameters) :
  ...
  //** computeQpResidual() *********************************************************
Real
MskLatentHeat::computeQpResidual()
{
  if (_Mask[_qp]<0.5)
    return 0.0;
...
//** computeQpJacobian() *********************************************************
Real
MskLatentHeat::computeQpJacobian()
{
...
Real
MskLatentHeat::computeQpOffDiagJacobian(unsigned int jvar)
{
  if (_Mask[_qp]<0.5)
    return 0.0;
