...
{
  return _Mu*_test[_i][_qp]*(_grad_u[_qp](_other_component)+_grad_v1[_qp](_component));
}
...
{
  return _Mu*_test[_i][_qp]*(_grad_phi[_j][_qp](_other_component));
}
...
{
  return _Mu*_test[_i][_qp]*(_grad_phi[_j][_qp](_component));
}
