...
{
  return _Lambda*_grad_test[_i][_qp]*(_grad_u[_qp](_component)+_grad_v1[_qp](_other_component));
}
...
{
  return _Lambda*_grad_test[_i][_qp]*(_grad_phi[_j][_qp](_component));
}
...
{
  return _Lambda*_grad_test[_i][_qp]*(_grad_phi[_j][_qp](_other_component));
}
