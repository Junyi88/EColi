...
template <>
InputParameters
validParams<MskStressDivergence>()
{
...
MskStressDivergence::MskStressDivergence(const InputParameters & parameters)
  : Kernel(parameters),
...
void
MskStressDivergence::computeResidual()
{
...
Real
MskStressDivergence::computeQpResidual()
{
  if (_Mask[_qp]<0.5)
    return 0.0;
...
void
MskStressDivergence::computeJacobian()
{
...
Real
MskStressDivergence::computeQpJacobian()
{
  if (_Mask[_qp]<0.5)
    return 0.0;
...
void
MskStressDivergence::computeOffDiagJacobian(unsigned int jvar)
{
  if (jvar == _var.number())
    computeJacobian();
  else
...
Real
MskStressDivergence::computeQpOffDiagJacobian(unsigned int jvar)
{
  if (_Mask[_qp]<0.5)
    return 0.0;
