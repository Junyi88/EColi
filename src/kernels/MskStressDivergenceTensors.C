...
template <>
InputParameters
validParams<MskStressDivergenceTensors>()
{
...
MskStressDivergenceTensors::MskStressDivergenceTensors(const InputParameters & parameters)
...
void
MskStressDivergenceTensors::initialSetup()
{
...
void
MskStressDivergenceTensors::computeResidual()
{
...
Real
MskStressDivergenceTensors::computeQpResidual()
{
  if (_Mask[_qp]<0.5)
    return 0.0;
...
void
MskStressDivergenceTensors::computeJacobian()
{
  if (_use_finite_deform_jacobian)
  {
...
void
MskStressDivergenceTensors::computeOffDiagJacobian(unsigned int jvar)
{
  if (_use_finite_deform_jacobian)
  {
    _finite_deform_Jacobian_mult.resize(_qrule->n_points());
...
void
MskStressDivergenceTensors::computeFiniteDeformJacobian()
{
...
void
MskStressDivergenceTensors::computeAverageGradientTest()
{
...
void
MskStressDivergenceTensors::computeAverageGradientPhi()
{
