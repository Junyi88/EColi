...
template <>
InputParameters
validParams<LqPhaseStressUpdate>()
{
...
LqPhaseStressUpdate::LqPhaseStressUpdate(const InputParameters & parameters)
...
void
LqPhaseStressUpdate::initQpStatefulProperties()
{
  _creep_strain[_qp].zero();
}

void
LqPhaseStressUpdate::propagateQpStatefulProperties()
{
...
void
LqPhaseStressUpdate::computeStressInitialize(const Real /*effective_trial_stress*/,
...
Real
LqPhaseStressUpdate::computeResidual(const Real effective_trial_stress, const Real scalar)
{
...
void
LqPhaseStressUpdate::computeStressFinalize(const RankTwoTensor & plasticStrainIncrement)
{
