[Mesh]
  file =./Files/Runs/TiAl_1D_BSeed/TiAl_1D_B1_R0_out.e
[]
...
[Materials]
  ...
  [./MagNoiseE]
    ...
    function='if(time<=0.01,1000.0*(1.0-tanh(400.0*(time-5.0e-3))),1.0)'
    #outputs = exodus
  [../]
  ...
  [./MagNoiseC]
    ...
    #constant_expressions = '1000.0 0.0 1500.0 0.01 10.0'
    #function = '30.0*exp(-400.0*time)'
    function='if(time<=0.005,10.0*(1.0-tanh(400.0*(time-5.0e-3))),1.0e-2)'
    #outputs = exodus
  [../]
