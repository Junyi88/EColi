...
[MeshModifiers]
  [./SubdomainBoundingBox1]
    ...
    top_right                    = '7.0 7.0 0.0'                  # The bottom left point (in x,y,z with spaces in-between).
...
#
#[Mesh]
#  file =./Files/Runs/TiAl_1D_ASeed/TiAl_1D_A1_R0_out.e
#[]
#
#[Variables]
#
...
[Materials]
  ...
  [./MagNoiseE]
    ...
    #function = '30.0*exp(-400.0*time)'
    function='if(time<=0.003,20.0*(1.0-tanh(800.0*(time-2.0e-3))),0.01)'
    #outputs = exodus
  [../]
  ...
  [./MagNoiseC]
    ...
    #constant_expressions = '1000.0 0.0 1500.0 0.01 10.0'
    #function = '30.0*exp(-400.0*time)'
    function='if(time<=0.003,10.0*(1.0-tanh(400.0*(time-5.0e-3))),0.01)'
    #outputs = exodus
  [../]
  ...
  [./MagNoiseQ]
    ...
    #constant_names = 'A1 A2 A3 A4 A5'
    #constant_expressions = '1000.0 0.0 1500.0 0.01 10.0'
    function = 'if(time<=0.003,200.0*exp(-50.0*time),0.0)'
    #outputs = exodus
  [../]
  # Shared Constants
  [./consts]
    ...
    prop_values = '6.4e2 0.09765625e-1 0.0625e-3
                   0.0625e-1 0.0625e-1 0.0625e-1
                   0.0625e-1 0.0625e-1 0.0625e-1
                   0.0625e-1 0.0625e-1 0.0625e-1'
  [../]
...
[AuxKernels]
  ...
  [./FunctionAux1]
    ...
    execute_on                   = LINEAR                      # Set to (nonlinear|linear|timestep_end|timestep_begin|custom) to execute ...
                                                               # only at that moment
    function                     = 't'                  # The function to use as the value
    seed                         = 0                           # The seed for the master random number generator
    type                         = FunctionAux
    use_displaced_mesh           = 0                           # Whether or not this object should use the displaced mesh for computation. ...
    ...
    variable                     = time                 # The name of the variable that this object applies to
  [../]
[]
##===============================================================
##: Preconditioning
