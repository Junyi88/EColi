...
[ICs]
  ...
  [./SmoothCircleIC_1_eta]
    ...
    invalue                      = 0.98                  # The variable value inside the circle
    outvalue                     = 0.02                  # The variable value outside the circle
  ...
  [./SmoothCircleIC_1_c]
    ...
    enable                       = 1                           # Set the enabled status of the MooseObject.
    int_width                    = 0                           # The interfacial width of the void surface.  Defaults to sharp interface
    invalue                      = 0.9163                  # The variable value inside the circle
    outvalue                     = 0.7244                  # The variable value outside the circle
    radius                       = 1.84                  # The radius of a circle
    rand_seed                    = 0                       # Seed value for the random number generator
    type                         = SmoothCircleIC
