...
[Materials]
  ...
  [./ComputeVariableEigenstrain]
    args                         = 'eta5'                  # variable dependencies for the prefactor
    eigen_base                   = '0.056 0.9375 0.0 0.0 0.0 0.0'                  # Vector of values defining the constant base tensor for the Eigenstrain
  ...
  [./elasticity_tensor]
    ...
    C_ijkl                       = '0.22 0.0623 0.0623
                                    0.175 0.0887 0.175
                                    0.04315 0.0622 0.0622'
  [../]

  [./strain]
    type = ComputeSmallStrain
    displacements = 'disp_x disp_y'
    eigenstrain_names            = Ei1
  [../]
  [./stress]
  ...
  [./ElasticEnergyMaterial]
    args                         = 'eta5'                  # Arguments of F() - use vector coupling
  ...
  [./consts]
   ...
   prop_values = '6.4e2 0.0625e-3  0.0625e-8 0.09765625e-2'
