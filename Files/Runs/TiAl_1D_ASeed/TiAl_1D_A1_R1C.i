[Mesh]
  file =./Files/Runs/TiAl_1D_ASeed/TiAl_1D_A1_R0C_out.e
[]
...
[Materials]
  ...
  [./MagNoiseE]
    ...
    function = '0.0'
    #function='10.0*(1.0-tanh(500.0*(time-5.0e-3)))'
    #outputs = exodus
  [../]
  ...
  [./MagNoiseC]
    ...
    #function='5.0*(1.0-tanh(800.0*(time-1.0e-3)))'
        function = '0.0'
    #outputs = exodus
  [../]
  ...
  #  #constant_names = 'A1 A2 A3 A4 A5'
  #  #constant_expressions = '1000.0 0.0 1500.0 0.01 10.0'
  #  function = 'if(time<=0.005,200.0*exp(-100.0*time),0.0)'
  #  #outputs = exodus
  #[../]
  # Shared Constants
  [./consts]
