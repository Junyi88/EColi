...
# Mesh
[Mesh]
  file =/work/jl1908/DropZone/GrainKenel/Strains/Kenel_1D_C46T1S2_R0_out.e
[]
...
[Materials]
  ...
  [./barrier]
    ...
    etas = 'eta1 eta2 eta3 eta4 eta51 eta52'
  ...
  # Total Free Energy
    [./free_energy]
      ...
      f_name = F
      fi_names = 'FLq  Falpha Fbeta Falpha2 Fgamma Fgamma'
      hi_names = 'h1  h2 h3 h4 h51 h52'
      etas     = 'eta1 eta2 eta3 eta4 eta51 eta52'
      args = 'Te c'
      g=getas
      W = 0.5e-2
...
# Mobilities
  ...
  [./Mob]
    type = ParsedMaterial
    f_name = M
    args = 'c eta1 eta2 eta3 eta4 eta51 eta52  Te'
  ...
  function ='(sqrt(eta1^2)*MLq+sqrt(eta2^2)*Malpha+sqrt(eta3^2)*Mbeta+sqrt(eta4^2)*
              Malpha2+sqrt((eta51+eta52)^2)*Mgamma)/d2F'
...
# Concentration
  ...
  [../]
  [./coupled_res]
    args = 'eta1 eta2 eta3 eta4 eta51 eta52 Te c'
    variable = w
    type = SplitCHWRes
    mob_name = M
  [../]
  [./coupled_parsed]
    args = 'eta1 eta2 eta3 eta4 eta51 eta52 Te'
    variable = c
    type = SplitCHParsed
    f_name = F
    kappa_name = kappa_c
  ...
  [./ACBulk1]
    type = AllenCahn
    variable = eta1
    args = 'eta2 eta3 eta4 eta51 eta52 Te c'
    mob_name = Leta
    f_name = F
  [../]
  [./ACInterface1]
    ...
    etas = 'eta1 eta2 eta3 eta4 eta51 eta52'
    mob_name = Leta
    kappa_names = 'kappaEta kappaEta kappaEta kappaEta kappaEta kappaEta'
  [../]
  ...
  [./ACBulk2]
    type = AllenCahn
    variable = eta2
    args = 'eta1 eta3 eta4 eta51 eta52 Te c'
    mob_name = Leta
    f_name = F
  [../]
  [./ACInterface2]
  ...
  [./ACBulk3]
    type = AllenCahn
    variable = eta3
    args = 'eta1 eta2 eta4 eta51 eta52 Te c'
    mob_name = Leta
    f_name = F
  [../]
  [./ACInterface3]
  ...
  [./ACBulk4]
    type = AllenCahn
    variable = eta4
    args = 'eta2 eta3 eta1 eta51 eta52 Te c'
    mob_name = Leta
    f_name = F
  [../]
  [./ACInterface4]
  ...
  [./ACBulk51]
    type = AllenCahn
    variable = eta51
    args = 'eta2 eta3 eta4 eta1 eta52 Te c'
    mob_name = Leta
    f_name = F
  [../]
  [./ACInterface51]
  ...
  [./ACBulk52]
    type = AllenCahn
    variable = eta52
    args = 'eta2 eta3 eta4 eta1 eta51 Te c'
    mob_name = Leta
    f_name = F
  [../]
  [./ACInterface52]
