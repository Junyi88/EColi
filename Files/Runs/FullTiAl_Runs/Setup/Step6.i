...
[Materials]
  ...
  [./free_energyP]
    ...
    function = '(g1+g51+g52+g53+g54+g55+g56)*1.0e-11'
...
[Kernels]
  ...
  [../]
  [./coupled_res]
    args = 'eta1 eta1 eta51 eta52 eta53 eta54 eta55 eta56 Te c'
    variable = w
    type = SplitCHWRes
    mob_name = M
  [../]
  [./coupled_parsed]
    args = 'eta1 eta1 eta51 eta52 eta53 eta54 eta55 eta56 Te'
    variable = c
    type = SplitCHParsed
    f_name = F
    kappa_name = kappa_c
