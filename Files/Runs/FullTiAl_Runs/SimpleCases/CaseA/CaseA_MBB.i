...
[Materials]
  ...
  [./consts]
    ...
    prop_values = '0.64e15 10.0e-16  10.0e-18'
  ...
  [./switching2]
    ...
    args = 'eta1'
    derivative_order             = 2
    function = '((1-eta1)^3)*(6*((1-eta1)^2)-15*(1-eta1)+10.0)'
    outputs = none
  [../]
  ...
  [./free_energy]
    type = DerivativeParsedMaterial
    f_name = F
    material_property_names = 'g1:=g1(eta1)  h1:=h1(eta1) h2:=h2(eta1)  FLq:=FLq(c,Te) Fbeta:=Fbeta(c,Te) '
    function = 'g1*(2.5e-15)+h1*FLq+(h2)*Fbeta'
    args = 'eta1 c Te'
    outputs = none
    derivative_order             = 2
  [../]
  ...
  [./Mob]
    ...
    material_property_names = 'MLq:=MLq(c,Te)
                               ...
                               Mgamma:=Mgamma(c,Te)
                               d2F:=D[F(Te,c),c,c]'
  function ='(sqrt(eta1^2)*MLq+sqrt((1-eta1)^2)*Mbeta)/d2F'
   outputs = none
  [../]
[]
