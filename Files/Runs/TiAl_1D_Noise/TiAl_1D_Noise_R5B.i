...
# Mesh
[Mesh]
  file =./Files/Runs/TiAl_1D_Noise/TiAl_1D_Noise_R4B_out.e
[]
#====================================================================
# Variables
[Variables]
...
[Materials]
  ...
  [./consts]
   ...
   prop_values = '6.4e2 0.09765625e-1 0.0625e-4
...
#  Noise
  [./MagNoiseE]
    ...
    args = 'time'
    #constant_names = 'A B'
    function='if(time<=0.01,200.0*(1.0-tanh(400.0*(time-2.0e-3))),0.01)'
    #outputs = exodus
  [../]
  ...
  [./MagNoiseC]
    ...
    function='if(time<=0.01,0.7*(1.0-tanh(400.0*(time-5.0e-3))),0.01)'
    #outputs = exodus
  [../]
