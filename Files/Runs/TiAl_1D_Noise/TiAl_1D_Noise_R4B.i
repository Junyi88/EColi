...
# Mesh
[Mesh]
  file =./Files/Runs/TiAl_1D_Noise/TiAl_1D_Noise_R3B_out.e
[]
#====================================================================
# Variables
[Variables]
...
#  Noise
  [./MagNoiseE]
    ...
    args = 'time'
    #constant_names = 'A B'
    function='if(time<=0.01,20.0*(1.0-tanh(400.0*(time-2.0e-3))),0.01)'
    #outputs = exodus
  [../]
  ...
  [./MagNoiseC]
    ...
    function='if(time<=0.01,0.5*(1.0-tanh(400.0*(time-5.0e-3))),0.01)'
    #outputs = exodus
  [../]
