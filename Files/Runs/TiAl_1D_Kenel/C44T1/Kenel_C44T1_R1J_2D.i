...
# Mesh
[Mesh]
  file =./Files/Runs/TiAl_1D_Kenel/C44T1/Kenel_C44T1_R0J_2D_out.e
[]
#====================================================================
# Variables
[Variables]
...
[AuxKernels]
  [./FunctionAux1]
    function                     = 'if(t<=1.0,1830.0-1450.0*t,400)'
    type                         = FunctionAux
    variable                     = Te
  [../]
  [./FunctionAux2]
...
[Materials]
  ...
  [./consts]
   ...
   prop_values = '6.4e2 0.0625e-2 0.0625e-6'
      #prop_values = '6.4e2 0.3e-1 0.0625e-6'
  [../]
