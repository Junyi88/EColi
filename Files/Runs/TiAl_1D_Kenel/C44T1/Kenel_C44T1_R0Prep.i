...
# Mesh
[Mesh]
  file =./Files/Runs/TiAl_1D_Kenel/C44T1/Kenel_C44T1_R0JLowkappa_out.e
[]
#====================================================================
# Variables
[Variables]
...
[AuxKernels]
  [./VariableGradientComponent1]
    ...
    gradient_variable            = 'c'                  # The variable from which to compute the gradient component
    type                         = VariableGradientComponent
    variable                     = 'grad_cx'                  # The name of the variable that this object applies to
  [../]
  [./FunctionAux1]
    function                     = '1501.13'
    type                         = FunctionAux
