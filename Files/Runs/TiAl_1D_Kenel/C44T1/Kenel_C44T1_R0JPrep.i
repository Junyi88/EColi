...
[ICs]
  ...
  #  inside                       = 0.45                           # The value of the variable inside the box
  #  outside                      = 0.43                           # The value of the variable outside the box
  #  type                         = BoundingBoxIC
  #  variable                     = c                  # The variable this initial condition is supposed to provide values for.
  #  x1                           = 0.0                  # The x coordinate of the lower left-hand corner of the box
  #  x2                           = 0.5                  # The x coordinate of the upper right-hand corner of the box
  #  y1                           = 0.0                  # The y coordinate of the lower left-hand corner of the box
  #  y2                           = 1.0                # The y coordinate of the upper right-hand corner of the box
  ...
  #[./BoundingBoxIC3]
  #  enable                       = 1                           # Set the enabled status of the MooseObject.
  #  inside                       = 0.90                           # The value of the variable inside the box
  #  outside                      = 0.525                           # The value of the variable outside the box
  #  type                         = BoundingBoxIC
  ...
  #[./BoundingBoxIC2]
  #  enable                       = 1                           # Set the enabled status of the MooseObject.
  #  inside                       = 0.025                           # The value of the variable inside the box
  #  outside                      = 0.40                           # The value of the variable outside the box
  #  type                         = BoundingBoxIC
...
[Materials]
  ...
  [./consts]
    ...
    prop_values = '2.4e3 0.0 0.0'
  # prop_values = '6.4e2 0.26e-4 0.0625e-8'
      #prop_values = '6.4e2 0.0625e-2 0.0625e-6'
  [../]
...
# Mobilities
  ...
  function ='(sqrt(eta1^2)*MLq+sqrt(eta2^2)*Malpha+sqrt(eta3^2)*Mbeta+sqrt(eta4^2)*Malpha2+sqrt(eta5^2)*Mgamma)/(d2F*1.0e4)'
