...
/****************************************************************/
#ifndef LQPHASEPOWERLAWCREEP_H
#define LQPHASEPOWERLAWCREEP_H
...
class LqPhaseStressUpdate : public RadialReturnStressUpdate
{
public:
  LqPhaseStressUpdate(const InputParameters & parameters);
...
template <>
InputParameters validParams<LqPhaseStressUpdate>();
