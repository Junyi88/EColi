...
/****************************************************************/
#ifndef MSKSTRESSDIVERGENCE_H
#define MSKSTRESSDIVERGENCE_H

#include "Kernel.h"

// Forward Declarations
class ColumnMajorMatrix;
class MskStressDivergence;
class SymmElasticityTensor;
class SymmTensor;

template <>
InputParameters validParams<MskStressDivergence>();

class MskStressDivergence : public Kernel
{
public:
  MskStressDivergence(const InputParameters & parameters);
