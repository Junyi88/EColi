...
/****************************************************************/
#ifndef MSKSTRESSDIVERGENCETENSORS_H
#define MSKSTRESSDIVERGENCETENSORS_H
...
class MskStressDivergenceTensors;
class RankTwoTensor;
class RankFourTensor;

template <>
InputParameters validParams<MskStressDivergenceTensors>();

/**
 * MskStressDivergenceTensors mostly copies from StressDivergence.  There are small changes to use
 ...
 */
class MskStressDivergenceTensors : public ALEKernel
{
public:
  MskStressDivergenceTensors(const InputParameters & parameters);
