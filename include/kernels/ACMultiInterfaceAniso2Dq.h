...
/****************************************************************/
#ifndef ACMULTIINTERFACEANISO2DQ_H
#define ACMULTIINTERFACEANISO2DQ_H
...
class ACMultiInterfaceAniso2Dq;
 ...
 */
class ACMultiInterfaceAniso2Dq : public Kernel
{
public:
  ACMultiInterfaceAniso2Dq(const InputParameters & parameters);
