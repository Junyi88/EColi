...
/****************************************************************/
#ifndef MELTTIMEDERIVATIVE_H
#define MELTTIMEDERIVATIVE_H
...
class MeltTimeDerivative;

template <>
InputParameters validParams<MeltTimeDerivative>();
...
{
public:
  MeltTimeDerivative(const InputParameters & parameters);
